    ...
    <section className="bg-[#F5F5F5] py-14 lg:py-20">
      <div className="mx-auto container px-5">
        ...
        <div className="flex justify-center mb-5">
          <div className="flex items-center gap-2 border border-gray-200 rounded-full px-4 py-2 bg-white text-xs sm:text-sm text-gray-600 font-medium">
        ...
        <div className="text-center mb-10 lg:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#FF5A1F]">
            We're Here to Help.
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {/* Customer Support */}
          <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm flex flex-col gap-4 h-full">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#FFF0EB] flex items-center justify-center hover:bg-[#FF5A1F] group"
                >
                  <FaInstagram className="text-[#FF5A1F] group-hover:text-white" />
                </a>
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-[#FFF0EB] flex items-center justify-center hover:bg-[#FF5A1F] group"
                >
                  <FaTwitter className="text-[#FF5A1F] group-hover:text-white" />
                </a>
              </div>
            </div>
          </div>
