...
const statuses: Array<TransactionStatus | "All"> = ["All", "Completed", "Pending", "Failed"];
...
export default function TransactionsFilter({ current, onChange, show, onToggle }: Props) {
  return (
