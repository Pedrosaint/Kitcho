...
export default function SuspendChefModal({ isOpen, onClose, chef }: Props) {
  if (!chef) return null;

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Suspend Chef" size="sm">
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Are you sure you want to suspend <span className="font-semibold">{chef.kitchenName}</span>? They will no longer be able to receive orders.
        </p>
