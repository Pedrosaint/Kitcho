...
export default function ApproveChefModal({ isOpen, onClose, chef }: Props) {
  if (!chef) return null;

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Approve Chef" size="sm">
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Are you sure you want to approve <span className="font-semibold">{chef.kitchenName}</span> ({chef.owner})? They will be able to start receiving orders.
        </p>
